...
docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org2.example.com/msp" peer2.org2.example.com peer channel fetch config -o {IP-HOST-1}:7050 -c composerchannel
